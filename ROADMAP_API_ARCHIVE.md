> **Archived.** Superseded by the current [ROADMAP_API.md](ROADMAP_API.md) (AI Draft read/write
> + app-side id-diff). Kept for the declarative-create API's history and design decisions.
